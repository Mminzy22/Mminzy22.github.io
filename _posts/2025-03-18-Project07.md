---
title: "사용자 중심 설계: AInfo의 회원가입과 마이페이지 기능 구현기"
author: mminzy22
...
Django 기본 유저 모델은 username 기반이라, 이메일 로그인 중심의 서비스에는 적합하지 않았습니다. 우리는 프로젝트 초기부터 `AbstractBaseUser`를 상속받아 **이메일 기반 커스텀 유저 모델**을 정의했습니다.
