...
> 이 글은 CI/CD의 핵심 개념과 이유, 파이프라인의 일반 흐름을 정리하고, **Build/Deploy의 정확한 의미**와 **언어별 빌드 차이(Java·Python·Node)**, 그리고 **AWS CodePipeline·GitHub Actions·Jenkins**의 특징과 예제를 한 번에 정리한 글입니다.
