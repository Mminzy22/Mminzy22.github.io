...
![문자 데이터 변경과 Group by 절 사용]({{ site.baseurl }}/assets/img/2024-11-20_groupBy01.png)

- 이메일 도메인별 고객 수와 평균 연령 구하기  
![문자 데이터 변경과 Group by 절 사용]({{ site.baseurl }}/assets/img/2024-11-20_groupBy02.png)

- ‘[지역(시도)] 음식점이름 (음식종류)’ 컬럼을 만들고, 총 주문건수 구하기  
![문자 데이터 변경과 Group by 절 사용]({{ site.baseurl }}/assets/img/2024-11-20_groupBy03.png)
